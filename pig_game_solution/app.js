...
function reset() {
  ...
  player1Panel.querySelector(".player-score").textContent = player1Total;
  player2Panel.querySelector(".player-score").textContent = player2Total;
}
...
rollBtn.addEventListener('click', function() {
  ...
  die1Ele.src = `dice-${diceRoll1}.png`;
  die2Ele.src = `dice-${diceRoll2}.png`;
  currentPlayerRoundScore.textContent = currentRoundScore;
});